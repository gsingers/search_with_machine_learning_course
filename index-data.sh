...
nohup bin/logstash --pipeline.workers 1 --path.data ./products_data -f /workspace/search_with_machine_learning_course/logstash/index-bbuy-queries.logstash > queries_indexing.log &