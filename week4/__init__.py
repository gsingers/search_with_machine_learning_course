...
def create_app(test_config=None):
    ...
    if test_config is None:
        ...
        #Adding the model reference of the best performing model
        QUERY_CLASS_MODEL_LOC = os.environ.get("QUERY_CLASS_MODEL_LOC", "/workspace/search_with_machine_learning_course/model_categories_with_params_1000.bin")
