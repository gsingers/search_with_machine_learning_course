...
product_root_path = '/workspace/datasets/product_data/products'
# products_0113_11280712_to_11358988.xml
...
@click.command()
@click.option('--source_dir', '-s', default=product_root_path, help='XML files source directory')
