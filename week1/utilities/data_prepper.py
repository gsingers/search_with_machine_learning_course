...
class DataPrepper:
    ...
    def __log_ltr_query_features(self, query_id, key, query_doc_ids, click_prior_query, no_results, terms_field="_id"):
        ...
        try:
            ...
            print("Could not process features", error, log_query)
            return None
        
        no_results = {}
        def entries_to_fields(hit):
            return {h['name']: h.get('value',0) for h in hit['fields']['_ltrlog'][0]['log_entry']}
