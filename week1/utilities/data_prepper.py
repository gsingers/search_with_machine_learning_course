...
class DataPrepper:
    ...
    def __log_ltr_query_features(self, query_id, key, query_doc_ids, click_prior_query, no_results, terms_field="_id"):
        ...
        return frame.astype({'doc_id': 'int64', 'query_id': 'int64', 'sku': 'int64', 'customer_review_count': 'int64', 'has_image': 'int64', 'has_online': 'int64', 'has_instore': 'int64'})
