...
if __name__ == "__main__":
    ...
    general.add_argument("-us",'--use_synonyms',
                         help='Synonyms search', default = "True")
    ...
    for line in sys.stdin:
        ...
        if query == "Exit":
            break
        hits = search(client=opensearch, user_query=query, index=index_name, use_synonyms = use_synonyms)
