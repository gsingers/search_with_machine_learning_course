...
shuf /workspace/datasets/fasttext/labeled_products.txt | head -n 10000 > /workspace/datasets/fasttext/shuffled_labeled_products.txt
...
shuf /workspace/datasets/fasttext/normalized_labeled_products.txt | head -n 10000 > /workspace/datasets/fasttext/shuffled_normalized_labeled_products.txt
